...
-- Insert some sample data for restaurants
INSERT INTO public.restaurants (owner_id, name, description, cuisine_type, address, phone, email, image_url, delivery_time_min, delivery_time_max, delivery_fee, is_featured) VALUES
('00000000-0000-0000-0000-000000000000', 'Burger Palace', 'Best burgers in town with fresh ingredients', 'American', '123 Main St, Downtown', '+1-555-0123', 'contact@burgerpalace.com', '/burger-sample.jpg', 25, 35, 2.99, true),
('00000000-0000-0000-0000-000000000000', 'Pizza Corner', 'Authentic Italian pizzas made with love', 'Italian', '456 Oak Ave, City Center', '+1-555-0456', 'info@pizzacorner.com', '/pizza-sample.jpg', 30, 40, 1.99, false),
('00000000-0000-0000-0000-000000000000', 'Fresh Greens', 'Healthy and delicious salads and bowls', 'Healthy', '789 Green Blvd, Uptown', '+1-555-0789', 'hello@freshgreens.com', '/salad-sample.jpg', 20, 30, 3.49, true);